...
train_generator = train_datagen.flow_from_directory("~/Data/Clean_data/train", target_size=(512, 512), batch_size=32, class_mode='categorical')
valid_generator = valid_datagen.flow_from_directory("~/Data/Clean_data/validation", target_size=(512, 512), batch_size=32, class_mode='categorical')
